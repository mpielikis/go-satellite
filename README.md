# satellite
a fork of github.com/joshuaferrara/go-satellite

    import "github.com/mpielikis/go-satellite"

## Intro

![Build Status](https://github.com/mpielikis/go-satellite/actions/workflows/go.yml/badge.svg)
